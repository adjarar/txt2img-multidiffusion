...
work_dir = "/mnt/c/Users/adjar/Desktop/script/"
...
txt2img_openpose(url, prompts, upscalers.ultrasharp, samplers.euler_a, openpose_img, output_dir_txt2img,
                 denoising_strength=0.7, steps=5, hr_steps=5, scale_factor=1, batch_size=1, iterations=1)

multidiffusion_upscale(url, output_dir_txt2img, output_dir_img2img, samplers.euler_a, upscalers.ultrasharp,
                       denoising_strength=0.3, steps=30, latent_batch_size=1, scale_factor=2)
